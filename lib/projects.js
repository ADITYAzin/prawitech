...
export const projects = [
  {
    ...
    client: "NexaCorp",
    title: "NexaCorp Enterprise Platform",
    ...
    detail: {
      ...
      visuals: [
        { type: "full", gradient: "from-[#0768FB]/70 to-[#1A1A1A]/90", caption: "Platform dashboard overview" },
        {
          type: "dual",
          gradients: ["from-[#1A1A1A]/80 to-[#0768FB]/60", "from-[#0768FB]/50 to-[#1A1A1A]/70"],
          captions: ["Lead management interface", "Automated quoting workflow"],
        },
        { type: "interactive", gradient: "from-[#0768FB]/80 to-[#1A1A1A]/85", caption: "Live pipeline analytics" },
      ],
    },
  },
  {
